...
//            for(Object bid : bids) {
////                brokers.add(zkUtils.getBrokerInfo((int) bid).get().getNode(ListenerName.forSecurityProtocol(protocol)).host()); // old core version
//                brokers.add(zkUtils.getBrokerInfo((int) bid).get().getNode(ListenerName.forSecurityProtocol(protocol)).get().host());
//            }
